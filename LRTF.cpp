/*
    In LRTF, Every process is sorted on the basis of longest burst time and
    executed only for one unit time and after that it re-check for arrived processes
    having longest burst time.
...
int main()
{
    ...
    cout << endl
         << endl;
    cout.width(42);
    cout << "ACCORDING TO LRTF ALGORITHM" << endl;
